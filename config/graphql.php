...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'books' => \App\GraphQL\Queries\BookQuery::class
            ],
            'mutation' => [
                'createBook' => \App\GraphQL\Mutation\CreateBookMutation::class,
    ...
    'types' => [
            ...
            App\GraphQL\Types\FilterBookInput::class,
            App\GraphQL\Types\UpdateBookInput::class,
            App\GraphQL\Types\CreateBookInput::class,
    ],
